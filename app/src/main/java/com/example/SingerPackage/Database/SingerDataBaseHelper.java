...
public class SingerDataBaseHelper {
    ...
    public ArrayList<Singer> getSingers() {
        ...
        singer.setImageFileName("https://i.picsum.photos/id/20/300/300.jpg");
        ...
        singer.setImageFileName("https://i.picsum.photos/id/21/300/300.jpg");
        singer.setSingerFileSong("https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3");
        singerArrayList.add(singer);

        singer = new Singer();
        singer.setName("Westlife");
        singer.setImageFileName("https://i.picsum.photos/id/22/300/300.jpg");
        ...
        singer.setImageFileName("https://i.picsum.photos/id/23/300/300.jpg");
        ...
        singer.setImageFileName("https://i.picsum.photos/id/24/300/300.jpg");
        ...
        singer.setImageFileName("https://i.picsum.photos/id/25/300/300.jpg");
